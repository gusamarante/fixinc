...
plt.savefig(figure_path.joinpath("Measuring Returns - DI Performance.pdf"))
plt.show()
plt.close()
...
plt.savefig(figure_path.joinpath("Measuring Returns - DI Performance Table.pdf"))
plt.show()
plt.close()
