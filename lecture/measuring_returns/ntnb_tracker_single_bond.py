...
plt.tight_layout()
plt.savefig(figure_path.joinpath('Measuring Returns - Single NTNB Total Return.pdf'))
plt.show()
plt.close()
...
plt.savefig(figure_path.joinpath('Measuring Returns - Single NTNB Returns and Vol.pdf'))
